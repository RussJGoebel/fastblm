#' PCG solver
#' Solves A x = b iteratively via preconditioned conjugate gradient
#' @param apply_A function v -> Av
#' @param b right hand side vector
#' @param x0 initial guess, default zero
#' @param precond optional preconditioner function v -> M^{-1} v
...
#' Uses Lanczos tridiagonalization + Gauss quadrature
#' @param apply_A function v -> Av
